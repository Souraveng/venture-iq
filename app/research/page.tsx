      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="rounded-xl p-5" style={{ background: "var(--card-bg)", border: "1px solid var(--card-border)" }}>
            ...
            <p className="text-xs mb-4" style={{ color: "var(--muted-fg)" }}>{t("globalEvMarketSize") !== "globalEvMarketSize" ? t("globalEvMarketSize") : "Global EV market size ($T) · 2024–2030"}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { title: t("keyTrend"), body: "India's EV market is growing at 49% CAGR, driven by government FAME-II subsidies and rising fuel costs. Charging infrastructure is the #1 bottleneck.", icon: "↑" },
            { title: t("opportunityWindow"), body: "Less than 3% of India's 5M+ EV owners have access to reliable charging management software. First-mover advantage is available now.", icon: "◎" },
          ].map((insight) => (
