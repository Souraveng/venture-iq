    ...
    data: [
      {
        ...
        problemText: "Enterprise teams waste hours orchestrating multi-step AI workflows manually.",
        solutionText: "NeuralFlux automates agent workflow orchestration with zero-code deployment.",
      },
      {
        id: "st-02",
        ...
        businessModel: "B2B Hardware",
        problemText: "Grid-scale energy storage is expensive and unreliable with lithium-ion.",
        solutionText: "Solid-state batteries that are 3x denser, safer, and cheaper at scale.",
      },
      {
        id: "st-03",
        ...
        businessModel: "B2B Pharma",
        problemText: "Traditional protein engineering is slow and expensive in living cells.",
        solutionText: "Cell-free systems that engineer targeted proteins 10x faster and cheaper.",
      },
      {
        id: "st-04",
        name: "VentureIQ Core",
        ...
        businessModel: "SaaS",
        problemText: "Founders waste months on fundraising with no structured deal flow.",
        solutionText: "AI-powered platform that matches startups with the right investors instantly.",
      },
      {
        id: "st-05",
        name: "EcoRoute",
        tagline: "Smart routes for green delivery fleets",
        category: "SAAS",
        stage: "SAFE",
        valuation: "$8M",
        targetAmount: "$1.5M",
        ...
        traction: "50+ fleets onboarded, 30% fuel savings",
        pitchDeckUrl: "#",
        verified: false,
        isPublished: true,
        industry: "Logistics / GreenTech",
        businessModel: "B2B SaaS",
        problemText: "Delivery companies overpay on fuel due to unoptimized routes.",
        solutionText: "AI-driven green route optimization that cuts fuel costs by 30%.",
        videoFormat: "9:16",
      },
    ],
  });
