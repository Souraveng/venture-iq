...
export default function FounderNotificationsPage() {
  ...
  return (
    <div ref={containerRef} className="max-w-4xl mx-auto pt-0 pb-8 px-4 font-sans text-white">
      
      {/* Page Header */}
      <div className="sticky top-0 bg-[#0e0e0e] z-30 pt-1 pb-4 mb-6 flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-white/10">
        <div>
