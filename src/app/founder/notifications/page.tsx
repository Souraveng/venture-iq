...
interface Notification {
  id: string;
  type: "PROFILE_UPDATE" | "CONNECTION_REQUEST" | "CHAT_MOVEMENT" | "TAGGED" | "RECOMMENDATION" | "INTRO_REQUEST";
  title: string;
  message: string;
  timestamp: string;
  read: boolean;
...
export default function FounderNotificationsPage() {
  ...
  return (
    <div ref={containerRef} className="max-w-4xl mx-auto pt-0 pb-8 px-4 font-sans text-[#18181b] dark:text-white">
        ...
        <div className="flex items-center gap-3 w-full max-w-2xl">
          ...
          {showCategoryDropdown && (
            <>
              ...
              />
              <div className="absolute right-0 top-full mt-2 w-64 bg-white/95 dark:bg-[#1f1f1f]/90 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-2xl p-2 shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      <div className="max-w-3xl mx-auto space-y-3.5 mt-6">
          {filteredNotifications.length === 0 ? (
            <div className="text-center py-20 bg-white/80 dark:bg-[#1f1f1f]/50 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-2xl">
            ...
            filteredNotifications.map(item => (
              <div
                ...
                className={`notification-card backdrop-blur-md border rounded-2xl p-4.5 transition-all flex items-start gap-4 relative overflow-hidden group ${
                  !item.read ? "bg-white dark:bg-[#1f1f1f]/50 border-black/10 dark:border-white/15 hover:border-black/20 dark:hover:border-white/20" : "bg-black/5 dark:bg-white/[0.02] border-black/5 dark:border-white/5 opacity-75"
                }`}
              >
